...
if(WITH_TESSERACT)
    ...
    if(TESSERACT_FOUND)
        sanitize_ldflags_for_libs(TESSERACT_LDFLAGS)
        list(APPEND INKSCAPE_INCS_SYS ${TESSERACT_INCLUDE_DIRS})
        list(APPEND INKSCAPE_LIBS ${TESSERACT_LDFLAGS})
        add_definitions(${TESSERACT_DEFINITIONS})
    else()
