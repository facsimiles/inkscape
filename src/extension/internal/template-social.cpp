...
"<preset name='" N_("X (Twitter) card image") "' label='1200 × 628 px' height='628' width='1200'/>"
"<preset name='" N_("X (Twitter) header") "' label='1500 × 500 px' height='500' width='1500'/>"
"<preset name='" N_("X (Twitter) post image") "' label='1024 × 512 px' height='512' width='1024'/>"
"<preset name='" N_("X (Twitter) profile picture") "' label='400 × 400 px' height='400' width='400' icon='social_square'/>"
"<preset name='" N_("X (Twitter) video landscape") "' label='1280 × 720 px' height='720' width='1280'/>"
"<preset name='" N_("X (Twitter) video portrait") "' label='720 × 1280 px' height='1280' width='720' icon='social_portrait'/>"
"<preset name='" N_("X (Twitter) video square") "' label='720 × 720 px' height='720' width='720' icon='social_square'/>"
