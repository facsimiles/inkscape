...
LPEMeasureSegments::LPEMeasureSegments(LivePathEffectObject *lpeobject) :
    ...
    message(_("Info Box"), _("Important messages"), "message", &wr, this, _("Use <b>\"Style Dialog\"</b> to more styling. Each meassure element has extra selectors... Also you can !important to override defaults..."))
{
