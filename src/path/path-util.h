...
/**
 * Creates a Livarot Path object from the SPItem. The Geom::PathVector extracted from
 ...
 *
 * @returns The extracted SPCurve wrapped in std::unique_ptr so should get freed automatically.
 */
