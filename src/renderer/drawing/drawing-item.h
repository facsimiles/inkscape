...
protected:
    ...
    virtual DrawingItem *_pickItem(Geom::Point const &p, double delta, unsigned flags, Geom::OptRect const &area_world = {}) { return nullptr; }
    ...
    std::shared_ptr<Colors::Space::AnySpace> _color_space; // interpolation color space
