...
#ifndef INKSCAPE_UI_TOOL_ELLIPTICAL_ARC_HANDLER_H
#define INKSCAPE_UI_TOOL_ELLIPTICAL_ARC_HANDLER_H
...
class EllipticalArcHandler : public CurveHandler
{
public:
    explicit EllipticalArcHandler(EllipticalManipulator &manipulator);

    ~EllipticalArcHandler() override = default;
...
private:
    ...
    Geom::Point _rays_at_drag_start;
};
} // namespace Inkscape::UI

#endif // INKSCAPE_UI_TOOL_ELLIPTICAL_ARC_HANDLER_H
