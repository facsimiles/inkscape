...
void EraserToolbar::setDesktop(SPDesktop *desktop)
{
    _desktop = desktop;

    if (_desktop) {
        _width_item.set_defocus_widget(_desktop->getCanvas());
        _thinning_item.set_defocus_widget(_desktop->getCanvas());
        _cap_rounding_item.set_defocus_widget(_desktop->getCanvas());
        _tremor_item.set_defocus_widget(_desktop->getCanvas());
        _mass_item.set_defocus_widget(_desktop->getCanvas());
    }
}
