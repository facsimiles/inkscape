...
void SprayToolbar::setDesktop(SPDesktop *desktop)
{
    _desktop = desktop;

    if (_desktop) {
        _width_item.set_defocus_widget(_desktop->getCanvas());
        _population_item.set_defocus_widget(_desktop->getCanvas());
        _rotation_item.set_defocus_widget(_desktop->getCanvas());
        _scale_item.set_defocus_widget(_desktop->getCanvas());
        _sd_item.set_defocus_widget(_desktop->getCanvas());
        _mean_item.set_defocus_widget(_desktop->getCanvas());
        _offset_item.set_defocus_widget(_desktop->getCanvas());
    }
}
