...
void CalligraphyToolbar::setDesktop(SPDesktop *desktop)
{
    _desktop = desktop;

    if (_desktop) {
        for (auto btn : {&_width_item, &_thinning_item, &_mass_item, &_angle_item, &_flatness_item, &_cap_rounding_item, &_tremor_item, &_wiggle_item}) {
