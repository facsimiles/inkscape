...
class Globals
{
    ...
    {
        auto const path_utf8 = Inkscape::IO::Resource::get_path_ustring(Inkscape::IO::Resource::SYSTEM, Inkscape::IO::Resource::PIXMAPS, "remove-color.png");
        auto const path = Glib::filename_from_utf8(path_utf8);
