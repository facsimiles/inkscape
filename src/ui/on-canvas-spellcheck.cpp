...
void OnCanvasSpellCheck::createSquiggle(MisspelledWord& misspelled, SPItem* item, const Text::Layout* layout)
{
    ...
    misspelled.squiggle.push_back( CanvasItemPtr<CanvasItemSquiggle>(
        new Inkscape::CanvasItemSquiggle(_desktop->getCanvasSketch(), squiggle_points_temp2, SQUIGGLE_COLOR_RED)
    ));
    misspelled.squiggle.back()->set_squiggle_params(3.0, 8.0, 0.10); // Amplitude, Wavelength, Sampling
