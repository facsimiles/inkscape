 ...
 */
std::pair<Rubberband::Mode const, CanvasItemCtrlType const> const SelectTool::get_default_rubberband_state() {
    auto mode = Rubberband::get_default_mode();
    auto handle = Rubberband::get_default_handle();
