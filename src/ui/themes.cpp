...
ThemeContext::get_symbolic_colors()
{
    ...
    css_str = "image{";
    css_str += "-gtk-icon-palette: warning " + Glib::ustring(colornamedwarning);
    css_str += ", error " + Glib::ustring(colornamederror);
    css_str += ", success " + Glib::ustring(colornamedsuccess);
    css_str += "} \n";
