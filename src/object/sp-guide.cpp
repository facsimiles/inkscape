...
char* SPGuide::description(bool const verbose) const
{
    ...
    if ( !this->document ) {
        ...
        gchar *shortcuts = g_strdup_printf("; %s", _("<b>Shift+drag</b> to rotate, <b>Ctrl+drag</b> to move origin, <b>Del</b> to delete; <b>double-click</b> to edit this guide's properties"));
