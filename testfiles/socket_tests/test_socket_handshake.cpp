...
public:
    ...
    static HandshakeMessage parse_welcome_message(std::string const &input)
    {
    ...
    static HandshakeMessage parse_reject_message(std::string const &input)
    {
        HandshakeMessage msg;
        msg.client_id = 0;
    ...
    static bool is_valid_welcome_message(std::string const &input)
    {
    ...
    static bool is_valid_reject_message(std::string const &input)
    {
    ...
    static bool is_handshake_message(std::string const &input)
    {
    ...
    static bool is_valid_client_id(int client_id) { return client_id > 0; }
    ...
    static std::string create_reject_message() { return "REJECT:Another client is already connected"; }
